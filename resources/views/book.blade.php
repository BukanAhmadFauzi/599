           ...
           <div class="col-md-12">
               <div class="card">
                   <div class="card-header">
                       ...
                       <button class="btn btn-primary float-left" data-toggle="modal" data-target="#tambahBukuModal"><i class="fa fa-plus"></i> Tambah Data</button>

                        <a href="{{ route('admin.print.books') }}" target="_blank" class="btn btn-success float-left"><i class="fa fa-print"></i> Cetak PDF</a>
